...
<form action="" enctype="multipart/form-data" method="post">
	...
	<div class="gray">
		<table width="100%" style="margin-bottom:0">
			<tr>
				...
				<table summary="" class="tab1">
					<tr>
						<td align="right"><strong>{LANG.content_product_codesp}</strong></td>
						<td>
						<input type="text" maxlength="50" value="{rowcontent.codesp}" name="codesp" style="width:80px"/>
						</td>
					...
					<tr>
						...
						<td>
						<input type="text" value="{rowcontent.product_discounts}" name="product_discounts" style="width: 100px;" />
						</td>
						<td align="right"><strong>{LANG.content_warranty}</strong></td>
						<td>
						<input type="text" maxlength="50" name="warranty" style="width:140px;" value="{rowcontent.warranty}">
						</td>
						<!--  <td align="right"><strong>{LANG.content_promotional}</strong></td>
						<td>
						<input type="text" maxlength="3" name="promotional" style="width:200px;" value="{rowcontent.promotional}">
						</td> -->
					</tr>
				</table>
				<table summary="" class="tab1" style="margin-bottom:0">
				...
				<table summary="" class="tab1">
                    ...
                    <tr>
                    	 <td >
                            <strong>{LANG.content_product_maps}</strong><br />
                         </td>
                    	 <td>
                            <strong></strong> <a href="http://www.khcnvn.com/forum/viewtopic.php?f=142&t=2703#p6775" title="{LANG.content_product_maps2}" target="_blank">{LANG.content_product_maps2}</a>
                            <br />
                            <input type="text" maxlength="255"  {maps} style="width:97%;"/>
                        </td>
                    </tr>
				</table>
				<table summary="" class="tab1">
				...
				<div style="margin-left:4px;">
					...
					<!-- END:block_cat -->
                    <!-- 
                            <table summary="" class="tab1" style="margin-bottom:0; border-top: 1px solid rgb(232, 232, 232); margin-top: 5px;">
                                <tbody class="second">
                                    <tr>
                                        <td>
                                        <strong>{LANG.content_color}</strong>
                                        </td>
                                    </tr>
                                </tbody>
                                <tbody>
    ...
    <!-- <div class="gray">
		<table summary="" class="tab1">
			<tbody>
				<tr>
					<td><strong>Khuyến mại chi tiết</strong></td>
				</tr>
			</tbody>
			<tbody class="second">
				<tr>
