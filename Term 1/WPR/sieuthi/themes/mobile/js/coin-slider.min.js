...
(function ($) {
    ...
    $.fn.coinslider = $.fn.CoinSlider = function (options) {
        ...
        $.setNavigation = function (el) {
            ...
            $('#cs-navigation-' + el.id).hide();
            $('#cs-navigation-' + el.id).append("<a href='#' id='cs-prev-" + el.id + "' class='cs-prev'><img src='../images/icon_prev.png' /></a>");
            $('#cs-navigation-' + el.id).append("<a href='#' id='cs-next-" + el.id + "' class='cs-next'><img src='../images/icon_next.png' /></a>");
            $('#cs-prev-' + el.id).css({
                'position': 'absolute',
