...
* @Language Tiếng Việt
* @Createdate Sep 27, 2012, 02:29:59 PM
*/
...
$lang_module['select0'] = "Lựa Chọn";
$lang_module['select1'] = "Hàng Mới";
$lang_module['select2'] = "Hàng Hot";
$lang_module['select3'] = "Hàng Nổi Bật";
$lang_module['select4'] = "Hàng Giảm Giá";
...
$lang_module['setting_active_commentfb'] = "Bật chức năng thảo luận Facebook";
$lang_module['setting_detail_note'] = "Ghi chú chi tiết sản phẩm";
$lang_module['setting_detail_note2'] = "Danh sách Hotline";
$lang_module['setting_detail_tel'] = "Điện thoại";
$lang_module['setting_detail_email'] = "Email";
...
$lang_module['content_homeimg'] = "Hình minh họa cho phần giới thiệu (Nên đăng ảnh kích thước 500px * 500px)";
...
$lang_module['content_showtimedeal'] = "Cho phép hiển thị công cụ đếm thời gian";
...
$lang_module['catalog_image'] = "Hình đại diện Catalog";

$lang_module['siteinfo_exptime'] = "Số sản phẩm hết hạn";
//color
$lang_module['color'] = "Màu sắc";
//color size
$lang_module['color'] = "Màu sắc";
$lang_module['size'] = "kích thước";
$lang_module['name_color'] = "Tên màu sắc";
$lang_module['errordel'] = "Lôi: vì một lí do nào đó mà không thể xoá được";
$lang_module['color'] = "Thêm màu sắc";
$lang_module['color_add'] = "Màu sắc";
$lang_module['size_add'] = "Kích thước";
$lang_module['color_error_name'] = 'Lỗi: Tên màu sắc không được để trống';
$lang_module['color_error_names'] = 'Lỗi: Tên màu sắc này đã tồn tại, hãy chọn tên khác';

$lang_module['name_color'] = "Tên màu sắc";
$lang_module['edit_color_cat']= "Sửa màu sắc";
$lang_module['size'] = "Thêm kích thước";
$lang_module['size_error_name'] = 'Lỗi: Tên size không được để trống';
$lang_module['size_error_names'] = 'Lỗi: Tên size này đã tồn tại, hãy chọn tên khác';

$lang_module['name_size'] = "Tên size";
$lang_module['edit_size_cat']= "Sửa size";
$lang_module['errordel'] = "Lỗi: vì một lí do nào đó mà không thể xoá được";
$lang_module['content_color'] = "Sản phẩm có các màu sắc";
$lang_module['content_size'] = "Sản phẩm có các size";
$lang_module['color'] = "Màu sắc";
$lang_module['size'] = "Kích thước";
$lang_module['color_zero'] ="---";
//maps
$lang_module['content_product_maps'] = "Toạ độ Maps";
$lang_module['content_product_maps2'] = "Hướng dẫn nhập toạ độ Maps";
//email
$lang_module['email_list'] = "Danh sách Email";
$lang_module['del_select'] = "Xóa mục chọn";
$lang_module['del_confim'] = "Bạn có chắc chắn muốn xóa";
$lang_module['del_complete'] = "Xoá thành công";
?>