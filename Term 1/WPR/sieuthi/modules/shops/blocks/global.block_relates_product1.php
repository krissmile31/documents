...
if ( ! nv_function_exists( 'nv_relates_product1' ) )
{

    function nv_block_config_relates1_blocks ( $module, $data_block, $lang_block )
    {
    ...
    function nv_block_config_relates1_blocks_submit ( $module, $lang_block )
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
    ...
    function nv_relates_product1 ( $block_config )
    {
        ...
        /*get theme block*/
        if ( file_exists( NV_ROOTDIR . "/themes/" . $global_config['site_theme'] . "/modules/" . $mod_file . "/block.others_product1.tpl" ) )
        {
...
if ( defined( 'NV_SYSTEM' ) )
{
    global $site_mods;
    $module = $block_config['module'];
    $content = nv_relates_product1( $block_config );
}
