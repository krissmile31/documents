...
if ( ! nv_function_exists( 'nv_relates_product' ) )
{
    ...
    function nv_relates_product ( $block_config )
    {
        ...
        /*get theme block*/
        if ( file_exists( NV_ROOTDIR . "/themes/" . $global_config['site_theme'] . "/modules/" . $mod_file . "/block.others_productnew.tpl" ) )
        {
		...
		$xtpl = new XTemplate( "block.others_productnew.tpl", NV_ROOTDIR . "/themes/" . $block_theme . "/modules/" . $mod_file );
