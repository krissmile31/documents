...
if ( ! nv_function_exists( 'nv_relates_product2' ) )
{
    ...
    function nv_relates_product2 ( $block_config )
    {
		...
		$xtpl = new XTemplate( "block.others_product2.tpl", NV_ROOTDIR . "/themes/" . $block_theme . "/modules/" . $mod_file );
		  ...
		  $xtpl->assign('A','align-right');
            ...
            if ( $pro_config['active_price'] == '1' && $l['showprice'] == '1' )
            {
                ...
                if ( $l['product_discounts'] != 0 )
                {
                    ...
                    $xtpl->assign( 'class_money', 'product-price' );
                    $xtpl->parse( 'main.loop.discounts' );
				
                }
                else
                {
                    $xtpl->assign( 'class_money', 'product-sales-price' );
                }
...
if ( defined( 'NV_SYSTEM' ) )
{
    global $site_mods;
    $module = $block_config['module'];
    $content = nv_relates_product2( $block_config );
}
