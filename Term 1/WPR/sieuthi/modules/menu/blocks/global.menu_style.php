...
if ( ! nv_function_exists( 'nv_menu_site' ) )
{
    ...
    {
        global $db, $module_name,$site_mods;
        ...
        $list = nv_db_cache( $sql, '_menu_rows'.$block_config['bid'], $module );
		foreach ( $list as $row )
        {
			$current_menu = "";
        ...
        {
            return nv_style_footer( $list_cats, $block_config );
        }        
        else
        {
            $style = 'side_menu_bar';
	...
	function nv_style_footer ( $list_cats, $block_config )
    {
        global $module_info;
        
        if ( file_exists( NV_ROOTDIR . "/themes/" . $module_info['template'] . "/modules/menu/header_menu.tpl" ) )
        {
            $block_theme = $module_info['template'];
        }
        else
        ...
        $xtpl = new XTemplate( "header_menu.tpl", NV_ROOTDIR . "/themes/" . $block_theme . "/modules/menu" );
        $xtpl->assign( 'BLOCK_THEME', $block_theme );
        $xtpl->assign( 'NV_BASE_SITEURL', NV_BASE_SITEURL );
	...
	function nv_style_type5 ( $list_cats, $block_config )
    {
        ...
        if ( file_exists( NV_ROOTDIR . "/themes/" . $module_info['template'] . "/modules/menu/footer.tpl" ) )
        {
            $block_theme = $module_info['template'];
        }
        else
        ...
        $xtpl = new XTemplate( "footer.tpl", NV_ROOTDIR . "/themes/" . $block_theme . "/modules/menu" );
        $xtpl->assign( 'BLOCK_THEME', $block_theme );
        $xtpl->assign( 'NV_BASE_SITEURL', NV_BASE_SITEURL );
