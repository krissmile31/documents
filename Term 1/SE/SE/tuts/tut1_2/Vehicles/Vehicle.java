 ...
 *    mutable(registrationNumber)=true /\ optional(registrationNumber)=false /\ max(registrationNumber)=12
 * @author Rain
 */
public class Vehicle {
  ...
  @DomainConstraint (type ="String", max=12,optional=false)
   ...
   * </pre>
   */
  @DOpt(type = OptType.Mutator) @AttrRef("registrationNumber")
  public void setRegistrationNumber(String registrationNumber) {
	  if(validateRegistrationNumber(registrationNumber))
		  this.registrationNumber = registrationNumber;
	  System.err.println("Vehicle.setRegistrationNumber: invalid number " + registrationNumber);
  }
  ...
  /**
   * @effects travelling detail from a given point to another point
   */
  public void travel() {
	  System.out.println("Type of vehicle: " + "\nThe two points" + "\nThe number of seats" + seatingCapacity);
  }
  ...
  protected boolean validateRegistrationNumber(String r) {
	  if(r == null || r.isEmpty() || r.length() > 12)
		  return false;
	  return true;
  }
}
