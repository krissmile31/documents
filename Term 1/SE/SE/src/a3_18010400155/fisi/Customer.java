...
public class Customer implements Comparable {
	...
	public void setAdress(String address) throws NotPossibleException {
		if (validateAddress(address))
			this.address = address;
		else
	...
	public boolean equals(Object o) {
		...
		// check if o is the same Customer (same state/ date)
	 ...
	 * </pre>
	 */
	protected boolean validate(int d, String name, String phoneNumber, String address) {
	 ...
	 * </pre>
	 */
	protected boolean validateAddress(String addres) {
