...
public class SortedSet implements Collection<Comparable> {
	...
	public void insert(Comparable x) {
		if (isIn(x))
			System.out.println("Element exists in SortedSet!");
		else {
			elements.add(x);
	 ...
	 * else
	 * 		return a generator that will produce all the elements of this in sequence.</pre>
	 * 
	...
	/**
	 * @overview SortedSet.SortedSetGen represents a generator of the elements of a SortedSet.
	 * 
	 * @attributes
	 * indx 		Integer
	 * 
