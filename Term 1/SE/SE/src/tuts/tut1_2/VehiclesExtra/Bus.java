package tut1_2.VehiclesExtra;

import tut1_2.Vehicles.Vehicle;
 ...
 *    mutable(routes)=false /\ optional(routes)=false /\ min(routes)=1 /\ max(routes)=100
 *   
 * @author Rain
 */
public class Bus extends Vehicle {
  ...
  private static final int MIN_ROUTES=1, MAX_ROUTES=100;
  ...
  /**
   * @effects <pre>
   *            if n, d, h, l, w, c, r, routes are valid
   *              initialise this as Bus:<n,d,h,l,w,c,r,routes>
   *            else
   *              print error message
   *          </pre>
   */
