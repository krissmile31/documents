...
public class Sorting {
   ...
   * 
   * @param v a vector of integral values
   ...
   * 
   */
  public static void quickSortAsc(Vector v) throws ClassCastException, NullPointerException {
   ...
   * 
   * @param v an array (here represented as a {@link Vector} to partition
   ...
   * 
   */
  public static void quickSort(Vector v) throws ClassCastException, NullPointerException {
    quickSort(v, 0, v.size() - 1);
  }
