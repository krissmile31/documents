 ...
 * 
 * @version - 2.0: provides a full implementation <br>
...
public class TitleTable {
   ...
   *          with its title to <code>this</code>.
   * @version 2.0
   */
   ...
   *          this title throws <code>NotPossibleException</code>, else returns
   *          the document with title <code>t</code>.
   * @version 2.0
   */
  ...
  /**
   * @effects if this is empty return null else return Iterator(Doc) for documents
   *          in this
   * 
  ...
  /**
   * @effects if this is empty return true else return false
   * 
   * @version 5.0 (for use in the assignment)
   */
