...
public class LinkedList<E> implements Collection<E> {
  ...
  /**
   * @overview 
   *   LinkedList.LinkedListGen represents a generator of the 
   *   elements of an LinkedList.
   * @attributes
   *  ind Integer
   * @abstract_properties
   *  mutable(ind)=false /\ min(ind)=0 /\ 
   *  ind<LinkedList.size() /\ 
   *  LinkedListGen.new = [x1,...] where 
   *    each xi is in LinkedListGen.LinkedList and
   *    xis are arranged in same order as
   *         LinkedListGen.LinkedList's elements. 
   */
