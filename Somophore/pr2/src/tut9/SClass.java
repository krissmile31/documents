...
public class SClass {
	 ...
	 */
	public SClass(@AttrRef("id") int id, @AttrRef("name") String name) {   //!optional, !collection
		if (!validateId(id)) {
     ...
     *      return false
     */
    public boolean validateStudents(Vector students) {
		for (int i = 0; i < students.size(); i++) {
