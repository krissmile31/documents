...
public class Person {
	...
	public Person(int id){  // Person(int id) constructor
		if (!validateId(id)) {
	...
	public Person(String name) {   // Person(String name) constructor
	...
	public Person(int id, String name){   // Person(int id, String name) constructor
